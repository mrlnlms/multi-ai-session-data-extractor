...
Uso:
    PYTHONPATH=. .venv/bin/python scripts/platform/notebooklm/reconcile.py --account 1
    PYTHONPATH=. .venv/bin/python scripts/platform/notebooklm/reconcile.py --account 2 --full
    PYTHONPATH=. .venv/bin/python scripts/platform/notebooklm/reconcile.py --account 1 --refetch-features rLM1Ne_metadata
"""
