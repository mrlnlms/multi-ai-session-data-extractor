...
Uso:
    PYTHONPATH=. .venv/bin/python scripts/platform/notebooklm/download-assets.py --account 1
    PYTHONPATH=. .venv/bin/python scripts/platform/notebooklm/download-assets.py --account 2
"""
