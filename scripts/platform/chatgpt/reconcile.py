...
Uso:
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/reconcile.py <raw_dir> [--previous-merged PATH]

Exemplo:
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/reconcile.py "data/raw/ChatGPT Data 2026-04-23/"
"""
