...
Uso:
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/sync.py [--no-voice-pass] [--full] [--no-binaries]
...
Pra rodar so um passo, use os scripts standalone:
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/export.py
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/download-assets.py data/raw/ChatGPT
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/download-project-sources.py data/raw/ChatGPT
    PYTHONPATH=. .venv/bin/python scripts/platform/chatgpt/reconcile.py data/raw/ChatGPT
