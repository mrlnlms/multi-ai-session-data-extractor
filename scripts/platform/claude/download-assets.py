...
Uso: PYTHONPATH=. .venv/bin/python scripts/platform/claude/download-assets.py [raw_dir]
...
if __name__ == "__main__":
    ...
    if args.raw_dir:
        ...
        raw = _default_raw()
        if not raw:
            print("ERRO: nao foi possivel achar raw — rode scripts/platform/claude/export.py primeiro")
            sys.exit(1)
