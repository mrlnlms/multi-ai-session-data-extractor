"""Sync Qwen — captura + reconcile em uma rodada.

Espelho de scripts/claude-sync.py e perplexity-sync.py.

Etapas:
    1. Capture     -> data/raw/Qwen/ (cumulativo)
    2. Reconcile   -> data/merged/Qwen/ (cumulativo, com preservation)
