...
consumes their sidecars. `recovery/` currently contains only the NotebookLM
legacy import, pending a separate classification review. These commands are
not normal pipeline stages; read the relevant runbook or source state record
linked from [`docs/README.md`](../docs/README.md) before using them.
