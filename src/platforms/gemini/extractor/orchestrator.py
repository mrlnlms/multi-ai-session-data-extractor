...
Sync orchestrador (`python -m src.platforms.gemini.commands.sync`) itera ambas.
...
from src.platforms.gemini.extractor.discovery import discover, persist_discovery
from src.platforms.gemini.extractor.fetcher import fetch_conversations
from src.platforms.gemini.extractor.refetch_known import refetch_known_gemini
