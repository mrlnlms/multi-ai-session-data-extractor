...
Uso:
  PYTHONPATH=. .venv/bin/python -m src.platforms.perplexity.commands.download_assets [raw_dir]
...
from src.platforms.perplexity.extractor.asset_downloader import download_assets
