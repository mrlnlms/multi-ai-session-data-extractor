...
Espelho do comando `python -m src.platforms.claude_ai.commands.sync`.
...
Uso: PYTHONPATH=. .venv/bin/python -m src.platforms.qwen.commands.sync
"""
...
from src.platforms.qwen.reconciler import run_reconciliation
