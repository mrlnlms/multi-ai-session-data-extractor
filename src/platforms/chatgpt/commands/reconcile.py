...
Uso:
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.reconcile <raw_dir> [--previous-merged PATH]

Exemplo:
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.reconcile "data/raw/ChatGPT Data 2026-04-23/"
"""
