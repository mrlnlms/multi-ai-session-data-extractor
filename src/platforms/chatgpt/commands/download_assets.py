...
Uso:
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.download_assets [raw_dir]
                                              [--only-conv ID] [--include-projects]

Exemplos:
    # Todas as convs com imagens do raw mais recente
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.download_assets "data/raw/ChatGPT Data 2026-04-23T12-40"

    # So 1 conv (pra teste)
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.download_assets "data/raw/ChatGPT Data ..." \\
