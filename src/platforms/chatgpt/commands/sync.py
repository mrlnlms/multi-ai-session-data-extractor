...
Uso:
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.sync [--no-voice-pass] [--full] [--no-binaries]
...
Pra rodar so um passo, use os scripts standalone:
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.export
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.download_assets data/raw/ChatGPT
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.download_project_sources data/raw/ChatGPT
    PYTHONPATH=. .venv/bin/python -m src.platforms.chatgpt.commands.reconcile data/raw/ChatGPT
...
from src.platforms.chatgpt.extractor.models import CaptureOptions
...
from src.platforms.chatgpt.reconciler import run_reconciliation
