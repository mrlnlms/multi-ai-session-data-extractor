...
Fase 0 (pre-requisito): rodar -m src.platforms.chatgpt.probes.inspect_voice_dom
...
from src.platforms.chatgpt.extractor.models import VoiceCapture, VoiceMessage
