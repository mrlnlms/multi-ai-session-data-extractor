...
Entry point chamado por ``python -m src.platforms.chatgpt.commands.export``.
"""
...
from src.platforms.chatgpt.extractor.dom_voice import capture_voice_dom, detect_voice_candidates
from src.platforms.chatgpt.extractor.fetcher import fetch_all
from src.platforms.chatgpt.extractor.models import CaptureOptions, CaptureReport
from src.platforms.chatgpt.extractor.refetch_known import refetch_known_via_page
