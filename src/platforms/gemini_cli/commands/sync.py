"""Sync Gemini CLI — copy + parse + log em 1 comando."""
...
def main(
    *,
    ...
    runtime = load_asset_runtime("gemini_cli")
    ...
    print("=" * 60)
    copy_result = _copy_source("gemini_cli")
    n_new = len(copy_result["new"])
    n_upd = len(copy_result["updated"])

    print()
    print("=" * 60)
    print("  Etapa 2/2 — Parse → data/processed/Gemini CLI/")
    print("=" * 60)
