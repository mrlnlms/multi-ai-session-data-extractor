...
Uso:
    PYTHONPATH=. .venv/bin/python -m src.platforms.notebooklm.commands.download_assets --account 1
    PYTHONPATH=. .venv/bin/python -m src.platforms.notebooklm.commands.download_assets --account 2
"""
