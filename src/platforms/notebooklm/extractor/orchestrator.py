...
from src.platforms.notebooklm.extractor.discovery import discover, persist_discovery
from src.platforms.notebooklm.extractor.fetcher import fetch_notebook, lite_fetch_notebook
from src.platforms.notebooklm.extractor.refetch_known import refetch_known_notebooklm
...
def _lite_metadata_equal(previous: object, current: object) -> bool:
    ...
    """
    from src.platforms.notebooklm.reconciler import _eq_lenient
