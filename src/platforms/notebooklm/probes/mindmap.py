...
Uso: PYTHONPATH=. .venv/bin/python src/platforms/notebooklm/probes/mindmap.py --account hello
"""
...
from src.platforms.notebooklm.extractor.auth import load_context, VALID_ACCOUNTS
