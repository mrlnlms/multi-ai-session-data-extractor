...
Espelho dos modulos `src.platforms.chatgpt.commands.sync` e
`src.platforms.perplexity.commands.sync`.
...
Uso: PYTHONPATH=. .venv/bin/python -m src.platforms.claude_ai.commands.sync
"""
...
from src.platforms.claude_ai.extractor.orchestrator import BASE_DIR as RAW_DIR, run_export
from src.platforms.claude_ai.reconciler import run_reconciliation
