...
Uso: PYTHONPATH=. .venv/bin/python -m src.platforms.claude_ai.commands.download_assets [raw_dir]
...
if __name__ == "__main__":
    ...
    if args.raw_dir:
        ...
        raw = _default_raw()
        if not raw:
            print("ERRO: nao foi possivel achar raw — rode python -m src.platforms.claude_ai.commands.export primeiro")
            sys.exit(1)
