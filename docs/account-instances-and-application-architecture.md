...
- [Personal AI Archive](PERSONAL_AI_ARCHIVE.md) — visao de produto;
- [Identidade dos dados e fidelidade do leitor](data-identity-and-reader-fidelity.md)
  — contrato tecnico atual de identidade; e
- [DVC runbook](dvc-runbook.md) — preservacao e fronteira atual com o
  consumidor.
