# Kimi (Moonshot AI) — discovery e schema
...
Os gaps abertos e limites de cobertura ficam em
[known-limitations.md](../../../known-limitations.md); o estado atual do parser
e da coleta fica em [state.md](state.md).
