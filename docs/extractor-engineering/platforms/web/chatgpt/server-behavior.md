...
`python -m src.platforms.chatgpt.commands.refetch_known` from the terminal. The "fail-fast"
...
`python -m src.platforms.chatgpt.commands.refetch_known` default updated 50 -> 10. The endpoint
