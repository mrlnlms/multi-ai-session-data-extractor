...
**76% dos notebooks na amostra legacy retornam chat=None** —
...
Documentar resultados em `docs/extractor-engineering/platforms/web/notebooklm/server-behavior.md` após bateria.
