...
| Qwen | 367 / 367 | user 313; assistant 54 | 367; input 294, output 54, context 19 | 100.0% | 367 / 0 | inline | Seven additional PNG paths are verified same-account/content duplicates; rotated signed-URL entries are consolidated and inline document text stays in domain tables |
