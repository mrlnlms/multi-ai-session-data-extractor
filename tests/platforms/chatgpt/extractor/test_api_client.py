...
from tests.platforms.chatgpt.extractor.conftest import load_fixture
...
async def test_request_429_retries_with_wait(mock_request_context, mock_api_response, mocker):
    ...
    mock_sleep = mocker.patch("src.platforms.chatgpt.extractor.api_client.asyncio.sleep", new_callable=mocker.AsyncMock)
...
async def test_request_429_gives_up_after_max_retries(mock_request_context, mock_api_response, mocker):
    ...
    mocker.patch("src.platforms.chatgpt.extractor.api_client.asyncio.sleep", new_callable=mocker.AsyncMock)
