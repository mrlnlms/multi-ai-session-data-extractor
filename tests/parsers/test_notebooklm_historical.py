...
_parse_script = Path(__file__).parents[2] / "scripts" / "platform" / "notebooklm" / "parse.py"
_spec = importlib.util.spec_from_file_location("notebooklm_parse_script", _parse_script)
notebooklm_parse_script = importlib.util.module_from_spec(_spec)
sys.modules["notebooklm_parse_script"] = notebooklm_parse_script
assert _spec.loader is not None
_spec.loader.exec_module(notebooklm_parse_script)
